...
Let's have a look at the breakdown of the various levels given the data at the 
school level.
```{r,fig.height=12, fig.width=12}
...
```{r}
ggplot(subset(school_data, Category == "All Students"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1, color = 'black') + scale_y_log10()
```
