...
p1 <- ggplot(subset(borough_data, Category == "All Students"), 
  ...
  geom_histogram(fill='red', binwidth = 1, color = 'black')
...
p3 <- ggplot(subset(borough_data, Category == "All Students"), 
  ...
  geom_histogram(fill='green', binwidth=1, color = 'black')
...
The plot are very similar to those of African Americans.Let's look at histograms 
for White students
```{r, fig.height=12, fig.width=12}
