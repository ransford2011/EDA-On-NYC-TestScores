...
Let's analyze how the plots over gender, and race.

Let's look at histograms for Females
```{r, fig.height=12, fig.width=12}
...
Let's look at histograms for African-Americans
```{r, fig.height=12, fig.width=12}
...
Let's look at histograms for Hispanics
```{r, fig.height=12, fig.width=12}
...
Let's look at histograms for White students
```{r, fig.height=12, fig.width=12}
...
Let's look at histograms for Asian students
```{r, fig.height=12, fig.width=12}
...
The difference in median scores between males and females is significant. Now 
let's look at the breakdown by race across all boroughs.
...
The median score for Asian students is at least 10 points higher than all other 
races.  It seems that Black and Hispanic students are having significantly lower 
test scores than other races.  Next we will look at the breakdown based on 
English speaking students and English Language learning students.
...
```
 ...
 1 and 2 students and the highest median proportion of level 3 and 4 students.  
 White students had a lower median proportion of level 1 and 2 students in 
 respect to Black and Hispanic students, but had a relatively equal proportion 
 of Level 2 students as well.
...
p1 <- ggplot(subset(school_data, Category == "All Students"), 
             aes(x = Level1Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p2 <- ggplot(subset(school_data, Category == "All Students"), 
             aes(x = Level2Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p3 <- ggplot(subset(school_data, Category == "All Students"), 
             aes(x = Level3Percentage)) + 
  geom_histogram(fill='green', binwidth=1)

p4 <- ggplot(subset(school_data, Category == "All Students"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1)
...
p1 <- ggplot(subset(school_data, Category == "Female"), 
             aes(x = Level1Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p2 <- ggplot(subset(school_data, Category == "Female"), 
             aes(x = Level2Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p3 <- ggplot(subset(school_data, Category == "Female"), 
             aes(x = Level3Percentage)) + 
  geom_histogram(fill='green', binwidth=1)

p4 <- ggplot(subset(school_data, Category == "Female"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1)
...
p1 <- ggplot(subset(school_data, Category == "Male"), 
             aes(x = Level1Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p2 <- ggplot(subset(school_data, Category == "Male"), 
             aes(x = Level2Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p3 <- ggplot(subset(school_data, Category == "Male"), 
             aes(x = Level3Percentage)) + 
  geom_histogram(fill='green', binwidth=1)

p4 <- ggplot(subset(school_data, Category == "Male"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1)
...
Let's look at histograms for Blacks

```{r, fig.height=12, fig.width=12}

p1 <- ggplot(subset(school_data, Category == "Black"), 
             aes(x = Level1Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p2 <- ggplot(subset(school_data, Category == "Black"), 
             aes(x = Level2Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p3 <- ggplot(subset(school_data, Category == "Black"), 
             aes(x = Level3Percentage)) + 
  geom_histogram(fill='green', binwidth=1)

p4 <- ggplot(subset(school_data, Category == "Black"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1)
...
p1 <- ggplot(subset(school_data, Category == "Hispanic"), 
             aes(x = Level1Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p2 <- ggplot(subset(school_data, Category == "Hispanic"), 
             aes(x = Level2Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p3 <- ggplot(subset(school_data, Category == "Hispanic"), 
             aes(x = Level3Percentage)) + 
  geom_histogram(fill='green', binwidth=1)

p4 <- ggplot(subset(school_data, Category == "Hispanic"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1)
...
Let's look at histograms for Whites

```{r, fig.height=12, fig.width=12}

p1 <- ggplot(subset(school_data, Category == "White"), 
             aes(x = Level1Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p2 <- ggplot(subset(school_data, Category == "White"), 
             aes(x = Level2Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p3 <- ggplot(subset(school_data, Category == "White"), 
             aes(x = Level3Percentage)) + 
  geom_histogram(fill='green', binwidth=1)

p4 <- ggplot(subset(school_data, Category == "White"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1)
...
Let's look at histograms for Asians

```{r, fig.height=12, fig.width=12}

p1 <- ggplot(subset(school_data, Category == "Asian"), 
             aes(x = Level1Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p2 <- ggplot(subset(school_data, Category == "Asian"), 
             aes(x = Level2Percentage)) + 
  geom_histogram(fill='red', binwidth = 1)

p3 <- ggplot(subset(school_data, Category == "Asian"), 
             aes(x = Level3Percentage)) + 
  geom_histogram(fill='green', binwidth=1)

p4 <- ggplot(subset(school_data, Category == "Asian"), 
             aes(x = Level4Percentage)) + 
  geom_histogram(fill='green', binwidth=1)
...
ggplot(school_data, aes(x = Level1Percentage, y = Mean.Scale.Score)) + 
  geom_point()
```
...
p1 <- ggplot(school_data, aes(x = Level1Percentage, y = Mean.Scale.Score)) + 
  geom_point(alpha = 1/25)


p2 <- ggplot(school_data, aes(x = Level2Percentage, y = Mean.Scale.Score)) + 
  geom_point(alpha = 1/25)

p3 <- ggplot(school_data, aes(x = Level3Percentage, y = Mean.Scale.Score)) + 
  geom_point(alpha = 1/25)

p4 <- ggplot(school_data, aes(x = Level4Percentage, y = Mean.Scale.Score)) + 
  geom_point(alpha = 1/25)
...
very useful when combining data from 2006-2012 with data from 2013-2015.
...
These plot support the claim that 2009 was the best year amongst them all 
...
tested more than 200. Let's see how the observations are distributed
...
number of Level 1 students decrease as the number of students tested increases.
Let's see how the same plot faceted over years looks like:
...
for each grade.  Given that "Number.Tested" is one of the few continuous scale 
metrics in this dataset, we use this so that we can a have more randomly 
distributed plots (versus the discrete values like "Year" and "Grade").


```{r geom_point_plot_9, cache=TRUE,cache.path= 'cache/', fig.path='figure/'}
by(school_data$Level1Percentage,school_data$Grade, summary)
ggplot(school_data, aes(x = Number.Tested, y = Level1Percentage)) +
  geom_point(alpha = 1/ 7, aes(color=Borough)) + 
  scale_color_brewer(palette = "Set1") + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  facet_wrap(~Grade)
```

For Level 1 students, there seems to be a higher concentration of Bronx schools 
with a high percentage level 1 students in Grades 4 and 5, but seems to diminish
in grades 7 and 8.  In grades 3-5, the distribution seems fairly uniform across 
the number.tested.  In contrast, for grades 6-8, there seems to be a decreasing 
trend in percentage of level 1 students as the number of tested increases. 
...
ggplot(school_data, aes(x = Number.Tested, y = Level2Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=Borough)) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set1") + 
  facet_wrap(~Grade)
...
For Level 2 students, there seems to be large proportion around the 50 percent 
mark across all grades. 
...
ggplot(school_data,aes(x = Number.Tested, y = Level3Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=Borough)) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set1") + 
  facet_wrap(~Grade)
...
For Level 3 students, Brooklyn is neatly condensed between ranges 25-75% for 
grades 3-5 and has a more scattered distribution in the higher grades.  You 
start to see more Queens and Staten Island observation points in the higher 
percentages in this plot.  Brooklyn has a noticeable concentration of points 
in the higher percentage end in grades 6-8 and the Bronx is mostly concentrated 
on the low end of the percentage scale across all grades. 
...
ggplot(school_data,aes(x = Number.Tested, y = Level4Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=Borough)) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set1") + 
  facet_wrap(~Grade)
...
In Level 4 students, we see a lot more points representing Manhattan.  There is 
a good concentration of Manhattan schools at the higher percentage end for all 
grades.  Staten Island has dense concentration around 50-75% in grades 3-5 and 
more scattered distribution on the low percentage side in the higher grades.  
Brooklyn has a high percentage of Level 4 students in grades 6-8 and Queens has 
high percentage of level 4 students across all grades.  Now let us investigate 
the student level percentages across each grade for each year to see how 
students performed in each grade over time.

```{r geom_point_plot_13, cache=TRUE,cache.path= 'cache/', fig.path='figure/'}
by(school_data$Level1Percentage,school_data$Year, summary)
ggplot(school_data, aes(x = Number.Tested, y = Level1Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=factor(Grade))) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set2") + 
  facet_wrap(~Year)
```

2009 seems to be the best year for testing as there was a high concentration of 
low percentage of level 1 students.  This is also supported by statistic 
information that shows that 75% of the observations in 2009 have less than 4.5% 
students who tested at Level 1.  In 2013, when the test changed, there was a big
shift in the data where the median percentage for students at Level 1 reaching 
almost 37%.
...
The percentage of students at level 2 is pretty vast across all years except 
2009.  8th graders seem to be the most prevalent illustrated by the plots.  
6th graders had noticeably high percentages of students at level 2 in 2013 and 
2014 as well.
...
We can see large percentages of schools having majority of their students reach
level 3 until the downturn in 2013.  From the statistical information, we can 
see the downturn being very drastic. 3rd and 7th graders seem to have dealt 
with the Common Core change in the test the better than the other grades.
...
The percentage of students testing at level 4 reached its peak in 2009 where 
the IQR was 22.50 and median percentage was 8.3%.  There are good amount of 
6th and 7th grade classes who reached level 4 at a high percentage across all 
years.

We can see there was a big disruption in the distribution of test scores from 
2013 when NYC decided to align more with the Common Core Standards. 8th graders 
seem to be having a difficult time with the standardized test as they dominate 
a large proportion in level 1 and 2 students. 6th and 7th graders seem to be 
doing the best over the years as they have large concentration of Level 3 and 
4 students. 3rd and 6th graders seem to have weathered the change in Test 
standards in 2013.  There is a dense concentration of Level 4 students in 
grades 3-5 from 2006-2009 but seems to dwindle after that.  It would be 
interesting to see how students in each grade performance was in respect to 
each subject.

```{r, fig.width= 12}
p1 <- ggplot(school_data, aes(x = Number.Tested, y = Level1Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=factor(Grade))) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set2") + 
  facet_wrap(~Subject)

p2 <- ggplot(school_data, aes(x = Number.Tested, y = Level2Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=factor(Grade))) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set2") + 
  facet_wrap(~Subject)

p3 <- ggplot(school_data, aes(x = Number.Tested, y = Level3Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=factor(Grade))) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set2") + 
  facet_wrap(~Subject)

p4 <- ggplot(school_data, aes(x = Number.Tested, y = Level4Percentage)) +
  geom_point(alpha = 1/ 7,aes(color=factor(Grade))) + 
  guides(color = guide_legend(override.aes = list(alpha = 1))) +
  scale_color_brewer(palette = "Set2") + 
  facet_wrap(~Subject)
...
Performance seems to be good from grades 3-7, but falls drastically in 8th 
grade.  Grades 4-6 seems to be the top performers in ELA. 8th graders seem to 
have a large concentration of Level 1 and 2 students in both subjects.


I have created another dataset which has the average percentages across all 
levels of students.  Let's analyze this dataset to see if it gives us any 
additional insight.
...
system. Given that my fiancée and my 11 year old stepson reside in the Bronx, 
...
need some further investigation as well.  Finally, I would like to get more 
insight as to why Black and Hispanic students are not performing as well as 
their White and Asian student counterparts.  This is very important to me as an African-American male who faced the same disconnect when growing up in the 
